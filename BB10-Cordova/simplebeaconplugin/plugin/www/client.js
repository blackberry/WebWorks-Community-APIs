...
var _self = {},
	_ID = "com.blackberry.community.simplebeaconplugin",
	...
	_self.startMonitoring = function (callback) {
		...
		exec(success, fail, _ID, "startMonitoring", null);
		if (sourceIsFunction) {
			return result;
		}
	};

	_self.stopMonitoring = function () {
		var result,
			success = function (data, response) {
				result = data;
			},
		...
		exec(success, fail, _ID, "stopMonitoring", null);
		return result;
	};
