...
JSExt* onCreateObject(const string& className, const string& id) {
	if (className == "SysDialogJS") {
		return new SysDialogJS(id);
	}
 ...
 */
string SysDialogJS::InvokeMethod(const string& command) {
...
void SysDialogJS::NotifyEvent(const std::string& event) {
