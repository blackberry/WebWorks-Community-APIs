...
//
public class TemplateExtension implements WidgetExtension 
{
...
//
    private String FEATURE_WEBWORKS_TEMPLATE = "webworks.template";
...
//
	...
	{
		System.out.println("TemplateExtension.getFeatureList");
	...
	{
		Object obj = null;
		System.out.println("TemplateExtension.loadFeature(" + feature + ")");
...
//
	...
	{
		System.out.println("TemplateExtension.register");
	...
	{
		System.out.println("TemplateExtension.unloadFeatures");
