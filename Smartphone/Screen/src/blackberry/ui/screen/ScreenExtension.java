...
import blackberry.ui.screen.ScreenNamespace;
 ...
 * 
 */
public class ScreenExtension implements WidgetExtension {

    private final static String[] _features = { ScreenNamespace.NAME };
	private BrowserField _browserField = null;
	private ScreenNamespace _screenNamespace = null;
