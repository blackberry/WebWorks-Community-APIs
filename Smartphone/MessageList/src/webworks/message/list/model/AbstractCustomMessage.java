...
public abstract class AbstractCustomMessage implements CustomMessageInterface, Persistable {
	 ...
	 */
	AbstractCustomMessage(String id, String sender, String subject, String message,
			long receivedTime) {
		_id = id;
		_sender = sender;
		_subject = subject;
	...
	public int getStatus() {
		...
		if (_isNew) {
			return CustomMessageImpl.STATUS_NEW;
		}
		if (_deleted) {
			return CustomMessageImpl.STATUS_DELETED;
		}
		if (_replyMessage != null) {
			// return CustomMessage.STATUS_REPLIED;
		}
		return CustomMessageImpl.STATUS_OPENED;
	}
