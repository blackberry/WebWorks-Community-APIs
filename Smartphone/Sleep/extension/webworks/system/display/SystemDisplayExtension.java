...
public final class SystemDisplayExtension implements WidgetExtension
{
	private String	FEATURE_SYSTEM_DISPLAY	= "webworks.system.display";
	...
	public void loadFeature(String feature, String version, Document doc, ScriptEngine scriptEngine) throws Exception
	{
		...
		{
			scriptEngine.addExtension(FEATURE_SYSTEM_DISPLAY, new SystemDisplayFeature());
		}
	}
