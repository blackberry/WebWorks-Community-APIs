...
public final class DeviceInfoExtension implements WidgetExtension
{
    private String	FEATURE_SYSTEM_DISPLAY	= "webworks.device.info";
    ...
    public void loadFeature(String feature, String version, Document doc, ScriptEngine scriptEngine) throws Exception
    {
        ...
        {
            scriptEngine.addExtension(FEATURE_SYSTEM_DISPLAY, new DeviceInfoNamespace());
        }
    }
