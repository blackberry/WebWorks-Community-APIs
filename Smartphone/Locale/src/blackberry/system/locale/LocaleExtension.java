...
import blackberry.system.locale.LocaleNamespace;
 ...
 * 
 */
public class LocaleExtension implements WidgetExtension {

    private final static String[] _features = { LocaleNamespace.NAME };
	private LocaleNamespace _localeNamespace = null;
