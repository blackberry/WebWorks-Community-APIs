...
public final class StorageExtension implements WidgetExtension
{
    private String	FEATURE_SYSTEM_DISPLAY	= "webworks.persistent.storage";
    ...
    public void loadFeature(String feature, String version, Document doc, ScriptEngine scriptEngine) throws Exception
    {
        ...
        {
            scriptEngine.addExtension(FEATURE_SYSTEM_DISPLAY, new StorageNamespace());
        }
    }
