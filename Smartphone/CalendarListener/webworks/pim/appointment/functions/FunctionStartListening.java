...
public static final String NAME = "startListening";
	...
	public FunctionStartListening(AptListenerManager aptListenerManager) {
    ...
    public Object execute( Object thiz, Object[] args ) throws Exception {
    		...
    		if(isNullOrEmpty(args)) {
    			throw new IllegalArgumentException("Missing arguments: expecting reference to event name and callback.");
    		}
